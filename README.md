...
dependencies {
    implementation 'com.aminography:primeadapter:1.0.9'
    compileOnly 'com.aminography:primeadapter-annotation:1.0.9'
    kapt 'com.aminography:primeadapter-processor:1.0.9'
}
```
