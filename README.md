...
dependencies {
    implementation 'com.aminography:primeadapter:1.0.5'
    compileOnly 'com.aminography:primeadapter-annotation:1.0.5'
    kapt 'com.aminography:primeadapter-processor:1.0.5'
}
```
