...
dependencies {
    implementation 'com.aminography:primeadapter:0.1.6'
    compileOnly 'com.aminography:primeadapter-annotation:0.1.6'
    kapt 'com.aminography:primeadapter-processor:0.1.6'
}
```
