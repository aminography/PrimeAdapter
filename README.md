...
dependencies {
    implementation 'com.aminography:primeadapter:1.0.12'
    compileOnly 'com.aminography:primeadapter-annotation:1.0.12'
    kapt 'com.aminography:primeadapter-processor:1.0.12'
}
```
