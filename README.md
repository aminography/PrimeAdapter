...
dependencies {
    implementation 'com.aminography:primeadapter:1.0.10'
    compileOnly 'com.aminography:primeadapter-annotation:1.0.10'
    kapt 'com.aminography:primeadapter-processor:1.0.10'
}
```
